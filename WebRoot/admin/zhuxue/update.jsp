				...
				<div class="page-content-area">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" action="<%=path%>/zhuxue/update"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="shu" name="shu" value="${zhuxue.shu}"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="jdate" name="jdate"
												value="${zhuxue.jdate}" class="col-xs-10 col-sm-5 date-picker" data-date-format="yyyy-mm-dd" />
										</div>
									</div>
